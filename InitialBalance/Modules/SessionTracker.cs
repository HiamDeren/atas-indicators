...
namespace Atas_Indicators.Modules
{
    ...
    //      _tracker = new SessionTracker(new TimeSpan(9,30,0), new TimeSpan(10,30,0));
    //      // in OnCalculate:
    ...
    public sealed class SessionTracker
    {
        ...
        /// <param name="start">Session open time in Eastern (e.g. 09:30).</param>
        /// <param name="end">Session close time in Eastern (e.g. 10:30). Supports overnight if end &lt; start.</param>
        ...
        private bool IsInWindow(DateTime utcTime)
        {
            ...
            return _start < _end
                ? t >= _start && t <= _end          // e.g. 09:30–10:30, end bar included
